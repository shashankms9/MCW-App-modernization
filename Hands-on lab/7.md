...
1. On the **Basics** tab of **Create application gateway** page, enter the below details:
    ...
    - Subnet: Select **subnet2 (8)** subnet from the drop-down list. If you not findout the subnet2 then click on **Manage subnet configuration**, click on **+ subnet** and enter Name as **subnet2** and enter Subnet address range as **10.0.1.0/24** and then click on **Save**.

      ![application](media/updated113.png)

    - Navigate back to application gateway click on **Create application gateway**.

      ![application](media/updated114.png)
