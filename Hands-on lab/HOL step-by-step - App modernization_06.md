...
2. On the **Security Center | Getting started** blade click on **Close** button.
   ![ContosoInsurance Azure SQL database into Azure Portal. Advanced Data Security is highlighted in the menu. Vulnerability Assessment section is highlighted](media/https://github.com/CloudLabs-MCW/MCW-App-modernization/blob/fix/Hands-on%20lab/local/e2-06-1.png?raw=true "VulnerabilityAssessment")

3. Now on the **Security center** blade click on **View additional findings in Vulnerability Assessment**.

   ![ContosoInsurance Azure SQL database into Azure Portal. Advanced Data Security is highlighted in the menu. Vulnerability Assessment section is highlighted](media/https://github.com/CloudLabs-MCW/MCW-App-modernization/blob/fix/Hands-on%20lab/local/e2-06.png?raw=true "Vulnerability Assessment")
...
5. When the scan completes, a dashboard displaying the number of failing and passing checks, along with a breakdown of the risk summary by severity level is displayed.
   ...
   ![Vulnerability Assessment window with the assessment results](media/https://github.com/CloudLabs-MCW/MCW-App-modernization/blob/fix/Hands-on%20lab/local/e2-08.png?raw=true "Vulnerability Assessment results")
...
6. In the scan results, take a few minutes to browse both the Failed and Passed checks, and review the types of checks that are performed. In the **Failed** the list, select any of the failed checks to view the detailed description.
   ...
   ![The details of the VA1143 - Transparent data encryption should be enabled finding are displayed with the description, impact, and remediation fields highlighted.](media/https://github.com/CloudLabs-MCW/MCW-App-modernization/blob/fix/Hands-on%20lab/local/vulnerability-assessment-failed-va1143-details.png?raw=true "Vulnerability Assessment")
