...
1. Return to the `ContosoInsurance` SQL database blade, from the left-hand menu select **Security Center** under security.
   ...
   ![ContosoInsurance Azure SQL database into Azure Portal. Advanced Data Security is highlighted in the menu. Vulnerability Assessment section is highlighted](https://github.com/CloudLabs-MCW/MCW-App-modernization/blob/fix/Hands-on%20lab/local/securitycenter?raw=true "VulnerabilityAssessment")
