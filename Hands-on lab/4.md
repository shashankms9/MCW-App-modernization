...
1. Create a Personal Access Token as described below.
     ...
     1. Now, Under Personal access tokens click on **Tokens(classic) (1)** and, select **Generate new token (2)** button on the right. Click on  **Generate             new  token(classic) (3)**. Provide the GitHub password if prompted.
