...
6. Choose the latest installer which will appear at the top of the list, scroll down to the list and click on **Download** 
   ...
   ![The Migration Wizard Select source blade is displayed, with the values specified above entered into the appropriate fields.](media/17-04-2024(7).png "Migration Wizard Select source")
