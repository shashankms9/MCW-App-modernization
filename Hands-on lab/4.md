...
1. Create a Personal Access Token as described below.
      ...
      i. In the upper-right corner of your GitHub page, select your profile photo, then click **Settings**.

         ![](https://github.com/CloudLabs-MCW/MCW-App-modernization/blob/stage/Hands-on%20lab/media/github-01.png?raw=true)

      ii. From the left hand side menu, select **Developer settings**.

          ![](media/github-02.png)

      iii. Now, click **Personal access tokens** and select **Generate new token** button on the right. Provide the GitHub password if prompted.

           ![](media/github-03.png)

      iv. Select the scopes or permissions you would like to grant this token.

          a. Note: Enter **Auth-token** in the note field.

          b. Select scopes: Select the following scopes when configuring your GitHub Personal Access Token
      ...
      v. Leave other values as default and select **Generate token**.
...
15. GitHub authentication screen will pop up. Provide **Personal Access Token** that you noted earlier and click on **Sign in**.
...
16. On the **Authorize Git Credential Manager** screen, select **Authorize GotCredentialManager**. This will give your local environment permission to push the code to GitHub.
...
18. Go back to GitHub and observe the repository with the source code uploaded.
