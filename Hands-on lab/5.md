...
9. Navigate to the staging environment endpoint in your browser and observe the Title change.
    ...
    ![Parts Unlimited staging environment is open in a browser. New Home Page title is highlighted.](media/staging-code-changes1.png "Parts Unlimited Staging Web Site")
