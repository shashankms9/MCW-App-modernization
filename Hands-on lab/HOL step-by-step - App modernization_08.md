# Exercise 5 (optional): Setup CI/CD pipeline with GitHub Actions for the web app
...
1. Create a Personal Access Token as described below.
     ...
     1. Now, click **Personal access tokens** and select **Generate new token** button on the right. Provide the GitHub password if prompted.
